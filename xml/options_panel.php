        ...
        <li class="value"><select name="XML:importmode" id="XML:importmode">
                <option value="local"
                    <?php if ($this->getParam("XML:importmode", "local") == "local") { ?>
                        selected="selected" <?php } ?>>Local
                </option>
                <option value="remote"
                    <?php if ($this->getParam("XML:importmode", "local") == "remote") { ?>
                        selected="selected" <?php } ?>>Remote
                </option>
            </select>
        ...
        <ul class="formline">
            ...
            <li class="value"><input type="text" name="XML:basedir"
                ...
                <div class="fieldinfo">Relative paths are relative to magento base
                    directory , absolute paths will be used as is
                </div>
            </li>
        </ul>
        <ul class="formline">
        ...
        <ul class="formline">
            ...
            <li class="value"><input type="text" name="XML:remoteurl"
                    ...
                    <?php if ($this->getParam("XML:forcedl", false) == true) { ?>
                        checked="checked" <?php } ?>>Force Download
            </li>
        </ul>
...
<div>
    <h3>XML options</h3>
    <span class="">XML parent element:</span>
    <input type="text"
           name="XML:elementparent"
           value="<?php echo $this->getParam("XML:elementparent") ?>"/>
    <span class="">XML element name:</span>
    <input type="text"
           name="XML:elementname"
           value='<?php echo $this->getParam("XML:elementname") ?>'/>
    <span class="">XML element xpath:</span>
    <input type="text"
           name="XML:xpath"
           value='<?php echo $this->getParam("XML:xpath") ?>'/>
</div>
